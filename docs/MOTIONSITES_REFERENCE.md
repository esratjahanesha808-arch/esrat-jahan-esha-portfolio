# MotionSites Reference

This document contains the original MotionSites prompt that generated one of my favorite portfolio websites.

This is NOT the design I want to copy.

Instead, analyze this prompt to understand the design philosophy behind it.
...
Especially analyze the Projects section and Service section.

Extract only the design principles.

Do NOT recreate the original website.

Do NOT reuse its colors, branding, content, or layout.

Instead, combine those ideas with the Slee Automation inspiration and my own content to build something completely original.
